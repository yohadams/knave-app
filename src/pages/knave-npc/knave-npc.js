...
import { style }  from './knave-npc.style';
import { get, translate  } from "lit-translate";
import { Router } from "@vaadin/router";

const stats = ['STR', 'DEX', 'CON', 'INT', 'WIS', 'CHA', 'ZBROJA']

export class KnaveNpc extends connect(store)(LitElement) {
  constructor() {
    super();
    ...
    this.randomCharacters = JSON.parse(window.localStorage.getItem('staticCharacters')) || [];
    this.editCharacter = '';
  ...
  saveToLocalStorage() {
    window.localStorage.setItem('staticCharacters', JSON.stringify(this.randomCharacters));
  }
...
customElements.define('knave-npc', KnaveNpc);
